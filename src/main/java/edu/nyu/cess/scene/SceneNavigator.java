...
import edu.nyu.cess.controller.Updatable;
...
public class SceneNavigator {
    ...
    private static void loadAllScenes() {
        loadScene(SceneName.CONNECT, "/connect.fxml");
        loadScene(SceneName.CALIBRATE, "/calibrate.fxml");
        loadScene(SceneName.CONNECT_WAIT, "/wait.fxml");
    }
